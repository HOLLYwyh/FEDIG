...
credit_data = credit_df.values[:, 1:]
census_data = census_df.values[:, :-1]
bank_data = bank_df.values[:, :-1]
...
df = df.append(pd.DataFrame({'data': ['credit'], 'number': [len(EIDIG_bank_id)], 'time': [EIDIG_bank_logger.total_time],
...
df = df.append(pd.DataFrame({'data': ['credit'], 'number': [len(EIDIG_census_id)], 'time': [EIDIG_census_logger.total_time],
...
NeuronFair_credit_id, NeuronFair_credit_logger = NeuronFair.individual_discrimination_generation('credit', config.Credit
                                                                                                 , credit_model)
df = df.append(pd.DataFrame({'data': ['census'], 'number': [len(NeuronFair_credit_id)], 'time': [NeuronFair_credit_logger.total_time],
...
NeuronFair_bank_id, NeuronFair_bank_logger = NeuronFair.individual_discrimination_generation('bank', config.Bank,
                                                                                             bank_model)
df = df.append(pd.DataFrame({'data': ['census'], 'number': [len(NeuronFair_bank_id)], 'time': [NeuronFair_bank_logger.total_time],
...
df = df.append(pd.DataFrame({'data': ['census'], 'number': [len(FEDIG_credit_id)], 'time': [FEDIG_credit_logger.total_time],
...
FEDIG_bank_id, FEDIG_bank_logger = FEDIG.individual_discrimination_generation('bank', config.Bank, bank_model)
df = df.append(pd.DataFrame({'data': ['census'], 'number': [len(FEDIG_bank_id)], 'time': [FEDIG_bank_logger.total_time],
...
df = df.append(pd.DataFrame({'data': ['census'], 'number': [len(DICE_credit_id)], 'time': [DICE_credit_logger.total_time],
...
df = df.append(pd.DataFrame({'data': ['census'], 'number': [len(DICE_bank_id)], 'time': [DICE_bank_logger.total_time],
