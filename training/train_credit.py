...
- This file also trains the DNN model of Credit Dataset
"""
...
# save the model
model.save('../models/trained_models/credit_model.h5')
print("Credit model has been saved...")

# Test_loss = 0.4901472914218903
# Test_accuracy = 0.7549999952316284
# Precision_rate = 0.5185185185185185
# Recall rate = 0.5490196078431373
