...
- This file also trains the DNN model of Census Dataset
"""
import pandas as pd
...
# save the model
model.save('../models/trained_models/census_model.h5')
print("Census model has been saved...")

# Test_loss = 0.3550533601572404
# Test_accuracy = 0.8282321691513062
# Precision_rate = 0.6715145436308927
